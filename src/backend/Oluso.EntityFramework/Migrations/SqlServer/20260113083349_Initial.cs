        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NonEditable = table.Column<bool>(type: "bit", nullable: false),
                    IsDynamicallyRegistered = table.Column<bool>(type: "bit", nullable: false),
                    RegistrationAccessTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastThreeChars = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Expiration = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedTenantIdsJson = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Token = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InvitedByUserId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedByUserId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    InvitationId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OrganizationId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Environment = table.Column<int>(type: "int", nullable: false, defaultValue: 4),
                    ...
                    ProtocolConfiguration_EnableDynamicClientRegistration = table.Column<bool>(type: "bit", nullable: true),
                    ProtocolConfiguration_AllowOpenDynamicRegistration = table.Column<bool>(type: "bit", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationAllowedScopesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationAllowedGrantTypesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequirePkce = table.Column<bool>(type: "bit", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationMaxRedirectUris = table.Column<int>(type: "int", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequiredScope = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequiredClaim = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequiredClaimValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
