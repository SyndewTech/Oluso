        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NonEditable = table.Column<bool>(type: "boolean", nullable: false),
                    IsDynamicallyRegistered = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedTenantIdsJson = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ...
                    AcceptedByUserId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedByUserId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    InvitationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProtocolConfiguration_EnableDynamicClientRegistration = table.Column<bool>(type: "boolean", nullable: true),
                    ProtocolConfiguration_AllowOpenDynamicRegistration = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    ProtocolConfiguration_DynamicRegistrationRequirePkce = table.Column<bool>(type: "boolean", nullable: true),
