        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Permissions = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ProfilePictureUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ...
                    TermsAcceptedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectEmail = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ...
                    ActivityId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientClaimsPrefix = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    NonEditable = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsDynamicallyRegistered = table.Column<bool>(type: "INTEGER", nullable: false),
                    RegistrationAccessTokenHash = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    UseJourneyFlow = table.Column<bool>(type: "INTEGER", nullable: true),
                    CibaEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    CibaRequireUserCode = table.Column<bool>(type: "INTEGER", nullable: false),
                    TenantId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NonEditable = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowedClientIds = table.Column<string>(type: "TEXT", nullable: false),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Updated = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastAccessed = table.Column<DateTime>(type: "TEXT", nullable: true),
                    TenantId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersistSubmissions = table.Column<bool>(type: "INTEGER", nullable: false),
                    SubmissionCollection = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    MaxSubmissions = table.Column<int>(type: "INTEGER", nullable: false),
                    AllowDuplicates = table.Column<bool>(type: "INTEGER", nullable: false),
                    DuplicateCheckFields = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    SuccessRedirectUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    SuccessMessage = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentStepId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ...
                    SessionId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AuthenticatedUserId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CorrelationId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CallbackUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    TenantId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    PolicyId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    PolicyName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    JourneyId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Data = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    UtmParameters = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebsiteUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    BillingCustomerId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    PlanId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageReference = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    ...
                    Enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    RequiredClaims = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    OutputClaims = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    ...
                    AverageExecutionMs = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceValueHash = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ClientId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    Uri = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ShowInDiscoveryDocument = table.Column<bool>(type: "INTEGER", nullable: false),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyVaultUri = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    SignatureCount = table.Column<long>(type: "INTEGER", nullable: false),
                    X5t = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    X5tS256 = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    CertificateIssuer = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CertificateSerialNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    Priority = table.Column<int>(type: "INTEGER", nullable: false),
                    IncludeInJwks = table.Column<bool>(type: "INTEGER", nullable: false),
                    TenantId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExceptionType = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    StackTrace = table.Column<string>(type: "TEXT", nullable: true),
                    TraceId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    SpanId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    RequestPath = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecretHash = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ApiVersion = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedBy = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", nullable: false),
                    LastThreeChars = table.Column<string>(type: "TEXT", nullable: true),
                    Expiration = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Type = table.Column<string>(type: "TEXT", nullable: false),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedTenantIdsJson = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    AcceptedByUserId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedByUserId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    InvitationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Updated = table.Column<DateTime>(type: "TEXT", nullable: true),
                    OrganizationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Environment = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 4),
                    ConnectionString = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    CustomDomain = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Branding_Id = table.Column<int>(type: "INTEGER", nullable: true),
                    Branding_LogoUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    Branding_FaviconUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    Branding_PrimaryColor = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Branding_SecondaryColor = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Branding_BackgroundColor = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ...
                    PasswordPolicy_RequireDigit = table.Column<bool>(type: "INTEGER", nullable: true),
                    PasswordPolicy_RequireLowercase = table.Column<bool>(type: "INTEGER", nullable: true),
                    PasswordPolicy_RequireUppercase = table.Column<bool>(type: "INTEGER", nullable: true),
                    PasswordPolicy_RequireNonAlphanumeric = table.Column<bool>(type: "INTEGER", nullable: true),
                    ...
                    PasswordPolicy_BlockCommonPasswords = table.Column<bool>(type: "INTEGER", nullable: true),
                    PasswordPolicy_CheckBreachedPasswords = table.Column<bool>(type: "INTEGER", nullable: true),
                    PasswordPolicy_CustomRegexPattern = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    PasswordPolicy_CustomRegexErrorMessage = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProtocolConfiguration_Id = table.Column<int>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_AllowedGrantTypesJson = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ProtocolConfiguration_AllowedResponseTypesJson = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ProtocolConfiguration_AllowedTokenEndpointAuthMethodsJson = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ProtocolConfiguration_SubjectTypesSupportedJson = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProtocolConfiguration_IdTokenSigningAlgValuesSupportedJson = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProtocolConfiguration_CodeChallengeMethodsSupportedJson = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProtocolConfiguration_DPoPSigningAlgValuesSupportedJson = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProtocolConfiguration_RequirePushedAuthorizationRequests = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_RequirePkce = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_AllowPlainPkce = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_RequireDPoP = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_ClaimsParameterSupported = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_RequestParameterSupported = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_RequestUriParameterSupported = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_FrontchannelLogoutSupported = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_BackchannelLogoutSupported = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_EnableDynamicClientRegistration = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_AllowOpenDynamicRegistration = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationAllowedScopesJson = table.Column<string>(type: "TEXT", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationAllowedGrantTypesJson = table.Column<string>(type: "TEXT", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequirePkce = table.Column<bool>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationMaxRedirectUris = table.Column<int>(type: "INTEGER", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequiredScope = table.Column<string>(type: "TEXT", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequiredClaim = table.Column<string>(type: "TEXT", nullable: true),
                    ProtocolConfiguration_DynamicRegistrationRequiredClaimValue = table.Column<string>(type: "TEXT", nullable: true),
                    ProtocolConfiguration_Created = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ProtocolConfiguration_Updated = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PlanId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    PlanExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    AllowSelfRegistration = table.Column<bool>(type: "INTEGER", nullable: false),
                    RequireTermsAcceptance = table.Column<bool>(type: "INTEGER", nullable: false),
                    TermsOfServiceUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    PrivacyPolicyUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    RequireEmailVerification = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowedEmailDomains = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    UseJourneyFlow = table.Column<bool>(type: "INTEGER", nullable: false),
                    EnableLocalLogin = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceScopes_Resources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventType = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    PayloadId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationInvitations_Email_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMemberships_OrganizationId_Role",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_TenantId_Uri",
                table: "Resources",
                columns: new[] { "TenantId", "Uri" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ResourceScopes_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelemetryLogs_Category",
                table: "TelemetryLogs",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryLogs_ClientId",
                table: "TelemetryLogs",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryLogs_Level",
                table: "TelemetryLogs",
                column: "Level");

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryLogs_TenantId",
                table: "TelemetryLogs",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryLogs_TenantId_Level_Timestamp",
                table: "TelemetryLogs",
                columns: new[] { "TenantId", "Level", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryLogs_TenantId_Timestamp",
                table: "TelemetryLogs",
                columns: new[] { "TenantId", "Timestamp" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tenants_OrganizationId_Environment",
                table: "Tenants",
                columns: new[] { "OrganizationId", "Environment" });
